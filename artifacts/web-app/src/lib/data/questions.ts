...
export const QUESTIONS: Question[] = [
  ...
  { id: "ux2", category: "ux-design", prompt: "Component libraries — what do you reach for?", options: [{ label: "Whatever the AI generates from scratch", score: 0 }, { label: "shadcn/ui defaults", score: 1 }, { label: "shadcn + 21st.dev + custom variants", score: 2 }, { label: "I maintain my own design system / tokens", score: 3 }] },
